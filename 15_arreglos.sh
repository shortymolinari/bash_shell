...
echo "Arreglo de Números v1 con *:${arregloRangos[*]}"
echo "Arreglo de Números V2 con @:${arregloRangos[@]}"
echo "Arreglo de Números v3 varios a la vez {[@]:1:2} :${arregloRangos[@]:1:2}"
